...
export const testimonials: Testimonial[] = [
  { name: "Aïssatou Diop", role: "DG, Sahel Logistique", context: "Entreprise", quote: "Tech-Xel a refondu notre plateforme logistique en 6 semaines. Résultat : +40 % de productivité côté terrain.", rating: 5 },
  { name: "Mouhamadou Sall", role: "CEO, NafaPay", context: "Startup", quote: "L'app mobile livrée par Tech-Xel a propulsé notre fintech. Design impeccable, code solide.", rating: 5 },
  ...
  { name: "Ibrahima Ba", role: "Particulier", context: "Particulier", quote: "Mon portfolio créé par Tech-Xel m'a permis de décrocher un contrat international. Merci !", rating: 5 },
